            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
              ...
              <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/Abi.png" alt="Abi" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Abishalini Mahendran
                    </h3>
                    <span className="text-blue dark:text-gray-200 px-2">Full-Stack Web Developer</span>
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Abi loves gymming, exploring the Kent wilderness and feeding her wanderlust.</p>
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/Siva.png" alt="Siva" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Siva Raj
                    ...
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Siva is a rebel at heart. He expresses it by always putting pineapple on a pizza.</p>
                    <ul className="flex space-x-4 sm:mt-0 px-2">
                      <li>
                        <a href="#" className="text-navy hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineDocumentText className="cursor-pointer text-2xl text-navy dark:text-lorange" />
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/Nisharu.png" alt="Nisharu" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Nisharu Ghaan
                    ...
                    <span className="text-blue dark:text-gray-200 px-2">Full-Stack Web Developer</span>
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Nisharu loves tutorials and story-telling. Perhaps he even loves the latter a bit too much.</p>
                    <ul className="flex space-x-4 sm:mt-0 px-2">
                      <li>
                        <a href="#" className="text-navy hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineDocumentText className="cursor-pointer text-2xl text-navy dark:text-lorange" />
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/Thasbi.png" alt="Thasbi" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Subekka Ambikaivakan
                    </h3>
                    <span className="text-blue dark:text-gray-200 px-2">Front-end Engineer</span>
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Subekka has always been a class clown. Suffice to say she still is. Handsome though.</p>
                    <ul className="flex space-x-4 sm:mt-0 px-2">
                      <li>
                        <a href="#" className="text-navy hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineDocumentText className="cursor-pointer text-2xl text-navy dark:text-lorange" />
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  ...
                  <div className="">
                    ...
                    <span className="text-blue dark:text-gray-200 px-2">Full-Stack Web Developer</span>
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Thasbi loves Hunger Games trilogy, Love Island and RuPaul's Drag Race.</p>
                    <ul className="flex space-x-4 sm:mt-0 px-2">
                      <li>
                        <a href="#" className="text-navy hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineDocumentText className="cursor-pointer text-2xl text-navy dark:text-lorange" />
          ...
          <section className="bg-cream dark:bg-blue">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
              <div className="mx-auto max-w-screen-sm text-center">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-navy dark:text-white">Join with us today</h2>
                <p className="mb-6 font-light text-blue dark:text-gray-200 md:text-lg">Try Career Companion for free. No credit card required.</p>
